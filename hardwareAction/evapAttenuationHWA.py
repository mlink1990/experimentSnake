...
class EvapAttenuation(hardwareAction.HardwareAction):
    ...
    def __init__(self, callbackTimeInSequence, **traitsDict):
        ...
        self.variableMappings = {"EvapSnakeAttenuationInitialVoltage":"EvapAttenuationVoltage"} #maps name in experiment control to names used in python callback. Make sure all required variables are defined!
        self.hardwareActionName = "evap-attenuation"
    ...
    def callback(self):
        ...
        try:
            ...
            attenuationInteger = self.getIntegerFromVoltage(self.finalVariables['EvapAttenuationVoltage'])
            ...
            return "%s: Attenuation voltage on VCO A High freq Na set to %g Volts" % (self.hardwareActionName,self.finalVariables['EvapAttenuationVoltage'] )
