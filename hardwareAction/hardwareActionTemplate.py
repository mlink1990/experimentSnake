...
class HardwareActionSubclass(hardwareAction.HardwareAction):
    
    def __init__(self, callbackTimeInSequence, **traitsDict):
        super(HardwareActionSubclass,self).__init__(callbackTimeInSequence,**traitsDict)
        self.variableMappings = {"experimentControlVariable":"PythonCallbackVariableName"} # CHANGE THIS LINE!  maps name in experiment control to names used in python callback. Make sure all required variables are defined!
        self.hardwareActionName = 'hardware-action-example'
